...
INDEX_OF_COLUMNS_SEARCHABLE = [1, 2, 3, 4, 6, 7, 13, 14, 15, 17, 18]
INDEX_OF_SPECIAL_COLUMNS_SEARCHABLE = [5, 16]   # where we need to look inside the widget_cell, not only item

INDEX_OF_COLUMNS_WITH_COMBOBOX = [8, 10, 11, 12, 19, 21, 22, 23]
INDEX_OF_COLUMNS_WITH_LINEEDIT = [5, 16]
