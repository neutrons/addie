...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.horizontalLayout.addWidget(self.ipts_combobox)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "IPTS #", None))
        self.label_2.setText(_translate("Dialog", "or", None))
        self.label_3.setText(_translate("Dialog", "Run Number", None))
