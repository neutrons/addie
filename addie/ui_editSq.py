...
#
# Created: Sat Oct 14 14:31:38 2017
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.pushButton_setScaleRange = QtGui.QPushButton(self.groupBox)
        self.pushButton_setScaleRange.setObjectName(_fromUtf8("pushButton_setScaleRange"))
        self.gridLayout.addWidget(self.pushButton_setScaleRange, 1, 4, 1, 1)
        ...
        self.lineEdit_shiftMin = QtGui.QLineEdit(self.groupBox)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.horizontalLayout.addWidget(self.lineEdit_shiftMin)
        ...
        self.lineEdit_shiftMax = QtGui.QLineEdit(self.groupBox)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.horizontalLayout.addWidget(self.lineEdit_shiftMax)
        self.gridLayout.addLayout(self.horizontalLayout, 0, 3, 1, 1)
        self.pushButton_setShiftRange = QtGui.QPushButton(self.groupBox)
        self.pushButton_setShiftRange.setObjectName(_fromUtf8("pushButton_setShiftRange"))
        self.gridLayout.addWidget(self.pushButton_setShiftRange, 0, 4, 1, 1)
        ...
        self.lineEdit_scaleMin = QtGui.QLineEdit(self.groupBox)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.horizontalLayout_2.addWidget(self.lineEdit_scaleMin)
        ...
        self.lineEdit_scaleMax = QtGui.QLineEdit(self.groupBox)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.horizontalLayout_2.addWidget(self.lineEdit_scaleMax)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.pushButton_setScaleRange.setText(_translate("Dialog", "Set", None))
        self.lineEdit_scaleFactor.setText(_translate("Dialog", "1", None))
        self.pushButton_setShiftRange.setText(_translate("Dialog", "Set", None))
