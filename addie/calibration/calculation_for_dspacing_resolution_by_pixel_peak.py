...
if __name__ == "__main__":
    ...
    # Make array where rows are pixels and cols are delta-d values (FWHM in
    # dspace)
    ...
    for pidx, tof_center, tof_width, dspace_idx in zip(
            pixel_idx_vals, center_vals, width_vals, dspace_idx_vals):
