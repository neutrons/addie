...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        QtCore.QObject.connect(self.lineEdit, QtCore.SIGNAL(_fromUtf8("textChanged(QString)")), Dialog.ipts_text_changed)
        QtCore.QMetaObject.connectSlotsByName(Dialog)
        Dialog.setTabOrder(self.import_button, self.ipts_combobox)
        Dialog.setTabOrder(self.ipts_combobox, self.lineEdit)
        Dialog.setTabOrder(self.lineEdit, self.run_number_lineedit)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "or", None))
