...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.page.setGeometry(QtCore.QRect(0, 0, 678, 440))
        ...
        self.page_2.setGeometry(QtCore.QRect(0, 0, 678, 440))
        ...
        self.number_of_files_not_found = QtGui.QLabel(self.page_3)
        self.number_of_files_not_found.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.number_of_files_not_found.setObjectName(_fromUtf8("number_of_files_not_found"))
        self.gridLayout.addWidget(self.number_of_files_not_found, 0, 1, 1, 1)
        self.number_of_files_to_import_label_3 = QtGui.QLabel(self.page_3)
        self.number_of_files_to_import_label_3.setObjectName(_fromUtf8("number_of_files_to_import_label_3"))
        self.gridLayout.addWidget(self.number_of_files_to_import_label_3, 0, 2, 1, 1)
        self.file_not_found_more = QtGui.QPushButton(self.page_3)
        self.file_not_found_more.setObjectName(_fromUtf8("file_not_found_more"))
        self.gridLayout.addWidget(self.file_not_found_more, 0, 3, 1, 1)
        spacerItem6 = QtGui.QSpacerItem(40, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.gridLayout.addItem(spacerItem6, 1, 0, 1, 1)
        self.number_of_files_initially_selected = QtGui.QLabel(self.page_3)
        self.number_of_files_initially_selected.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.number_of_files_initially_selected.setObjectName(_fromUtf8("number_of_files_initially_selected"))
        self.gridLayout.addWidget(self.number_of_files_initially_selected, 1, 1, 1, 1)
        self.number_of_files_to_import_label_2 = QtGui.QLabel(self.page_3)
        self.number_of_files_to_import_label_2.setObjectName(_fromUtf8("number_of_files_to_import_label_2"))
        self.gridLayout.addWidget(self.number_of_files_to_import_label_2, 1, 2, 1, 1)
        self.file_initially_selected_more = QtGui.QPushButton(self.page_3)
        self.file_initially_selected_more.setObjectName(_fromUtf8("file_initially_selected_more"))
        self.gridLayout.addWidget(self.file_initially_selected_more, 1, 3, 1, 1)
        spacerItem7 = QtGui.QSpacerItem(40, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.gridLayout.addItem(spacerItem7, 2, 0, 1, 1)
        self.number_of_files_filtered_out = QtGui.QLabel(self.page_3)
        self.number_of_files_filtered_out.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.number_of_files_filtered_out.setObjectName(_fromUtf8("number_of_files_filtered_out"))
        self.gridLayout.addWidget(self.number_of_files_filtered_out, 2, 1, 1, 1)
        self.number_of_files_filtered_out_label = QtGui.QLabel(self.page_3)
        self.number_of_files_filtered_out_label.setObjectName(_fromUtf8("number_of_files_filtered_out_label"))
        self.gridLayout.addWidget(self.number_of_files_filtered_out_label, 2, 2, 1, 1)
        self.files_filtered_out_more = QtGui.QPushButton(self.page_3)
        self.files_filtered_out_more.setObjectName(_fromUtf8("files_filtered_out_more"))
        self.gridLayout.addWidget(self.files_filtered_out_more, 2, 3, 1, 1)
        spacerItem8 = QtGui.QSpacerItem(40, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.gridLayout.addItem(spacerItem8, 3, 0, 1, 1)
        self.number_of_files_to_import = QtGui.QLabel(self.page_3)
        self.number_of_files_to_import.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.number_of_files_to_import.setObjectName(_fromUtf8("number_of_files_to_import"))
        self.gridLayout.addWidget(self.number_of_files_to_import, 3, 1, 1, 1)
        self.number_of_files_to_import_label = QtGui.QLabel(self.page_3)
        self.number_of_files_to_import_label.setObjectName(_fromUtf8("number_of_files_to_import_label"))
        self.gridLayout.addWidget(self.number_of_files_to_import_label, 3, 2, 1, 1)
        self.files_imported_more = QtGui.QPushButton(self.page_3)
        self.files_imported_more.setObjectName(_fromUtf8("files_imported_more"))
        self.gridLayout.addWidget(self.files_imported_more, 3, 3, 1, 1)
        self.verticalLayout_4.addLayout(self.gridLayout)
        spacerItem9 = QtGui.QSpacerItem(20, 142, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        ...
        QtCore.QObject.connect(self.file_not_found_more, QtCore.SIGNAL(_fromUtf8("clicked()")), Dialog.files_not_found_more_clicked)
        QtCore.QObject.connect(self.file_initially_selected_more, QtCore.SIGNAL(_fromUtf8("clicked()")), Dialog.files_initially_selected_more_clicked)
        QtCore.QObject.connect(self.files_filtered_out_more, QtCore.SIGNAL(_fromUtf8("clicked()")), Dialog.files_filtered_out_more_clicked)
        QtCore.QObject.connect(self.files_imported_more, QtCore.SIGNAL(_fromUtf8("clicked()")), Dialog.files_imported_more_clicked)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.number_of_files_not_found.setText(_translate("Dialog", "0", None))
        ...
        self.files_filtered_out_more.setText(_translate("Dialog", "more ...", None))
        self.number_of_files_to_import.setText(_translate("Dialog", "0", None))
        self.number_of_files_to_import_label.setText(_translate("Dialog", "Files will be imported!", None))
        self.files_imported_more.setText(_translate("Dialog", "more ...", None))
        self.toolBox.setItemText(self.toolBox.indexOf(self.page_3), _translate("Dialog", "Summary", None))
