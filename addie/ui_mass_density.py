...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.mass_error_message = QtGui.QLabel(Dialog)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        QtCore.QObject.connect(self.mass_density_line_edit, QtCore.SIGNAL(_fromUtf8("returnPressed()")), Dialog.mass_density_value_changed)
        QtCore.QObject.connect(self.number_density_line_edit, QtCore.SIGNAL(_fromUtf8("returnPressed()")), Dialog.number_density_value_changed)
        QtCore.QObject.connect(self.mass_line_edit, QtCore.SIGNAL(_fromUtf8("returnPressed()")), Dialog.mass_value_changed)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.volume_label.setText(_translate("Dialog", "N/A", None))
        self.volume_units.setText(_translate("Dialog", "cm3", None))
        self.mass_error_message.setText(_translate("Dialog", "Geometry Dimensions Have Not Been Defined! ", None))
