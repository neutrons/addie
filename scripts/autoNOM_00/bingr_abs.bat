...
qbinning,h9999,9999,9999,calfile='nomad_78208.calfile',sil=1,normfactor=nf9999
restore,'afsample.dat'
grouping,h9999,a9999,b9999,p9999,t9999,nf9999,mask=mask,lamfil=1,non=1,$
abskorr=1,af=af,aqdep=aqdep78208
qbinning,hback,9999,backnr,calfile='nomad_78208.calfile',sil=1,normfactor=nfback
...
muscat,a9999-aback,ams9999,sstruc.muscat,normfile='norm78211.dat'
ams9999=ams9999+aback
save,a9999,b9999,t9999,p9999,nf9999,ams9999,file='all9999_c.dat'
creategr,ams9999,b9999,back='backsample.dat',norm='norm78211.dat',$
