...
# Form implementation generated from reading ui file 'designer/ui_oncat_error_message.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.verticalLayout.addWidget(self.list_of_runs)
